/*! DomotiApp Cards 0.1.9 | MIT | https://github.com/Sven2410/domotiapp-cards */
var R=`
  --dac-bg:            #0c0c0a;
  --dac-bg-raise:      #12120f;
...
`;function V(i){let e=new CSSStyleSheet;return e.replaceSync(i),e}var N=i=>String(i??"").split(".")[0],f=(i,e)=>e&&i?.states?.[e]||null,M=(i,e)=>f(i,e)?.attributes??{},Q=(i,e,t)=>t?null:M(i,e).entity_picture||null;function C(i,e,t){return t||M(i,e).friendly_name||e||""}var nt=new Set(["scene","script","input_button","button","event"]),G=i=>nt.has(N(i));function I(i){return!i||i.state==="unavailable"?!0:i.state==="unknown"?!G(i.entity_id):!1}function ee(i){if(!i)return!1;let e=i.state;if(e==="unavailable"||e==="unknown")return!1;switch(N(i.entity_id)){case"cover":return e==="open"||e==="opening";case"alarm_control_panel":return e.startsWith("armed")||e==="triggered"||e==="arming";case"climate":case"water_heater":case"humidifier":return e!=="off";case"person":case"device_tracker":return e==="home";case"media_player":return e!=="off"&&e!=="idle"&&e!=="standby";default:return e==="on"||e==="playing"||e==="active"||e==="heat"}}function Ve(i,e,t){if(!i||i.themes!==e.themes||i.language!==e.language)return!0;for(let n of t)if(n&&i.states?.[n]!==e.states?.[n])return!0;return!1}function J(i,e,t={}){i.dispatchEvent(new CustomEvent(e,{detail:t,bubbles:!0,composed:!0,cancelable:!1}))}var P=(i,e)=>J(i,"hass-more-info",{entityId:e});function te(i){switch(N(i)){case"light":case"switch":case"fan":case"input_boolean":case"automation":case"siren":return{action:"toggle"};case"script":case"scene":case"input_button":case"button":return{action:"toggle"};default:return{action:"more-info"}}}function it(i){switch(N(i)){case"scene":return["scene","turn_on"];case"script":return["script","turn_on"];case"input_button":return["input_button","press"];case"button":return["button","press"];case"lock":return["lock","open"];case"cover":return["cover","toggle"];case"media_player":return["media_player","media_play_pause"];default:return["homeassistant","toggle"]}}function ne(i,e,t,n){if(!(!n||n.action==="none"))switch(n.action){case"more-info":P(i,n.entity||t.entity);break;case"toggle":{let a=n.entity||t.entity;if(!a)break;let[o,r]=it(a);e.callService(o,r,{entity_id:a});break}case"perform-action":case"call-service":{let a=n.perform_action||n.service;if(!a)break;let[o,r]=a.split(".");e.callService(o,r,n.data??n.service_data??{},n.target);break}case"navigate":if(!n.navigation_path)break;history.pushState(null,"",n.navigation_path),J(window,"location-changed",{replace:!1});break;case"url":n.url_path&&window.open(n.url_path,n.target??"_blank");break;case"assist":J(i,"show-dialog",{dialogTag:"ha-voice-command-dialog",dialogImport:()=>{},dialogParams:{}});break;case"fire-dom-event":J(i,"ll-custom",n);break;default:break}}function A(i,{onTap:e,onHold:t,onDouble:n}){let r=0,c=0,l=null,h=u=>{u.button!=null&&u.button!==0||(r=Date.now())},p=()=>{let u=r?Date.now()-r:0;if(r=0,t&&u>=500){navigator.vibrate?.(18),t();return}if(!n){e?.();return}if(c++,c===1){l=setTimeout(()=>{c=0,e?.()},260);return}clearTimeout(l),c=0,n()};return i.addEventListener("pointerdown",h),i.addEventListener("click",p),i.addEventListener("contextmenu",u=>u.preventDefault()),()=>{clearTimeout(l),i.removeEventListener("pointerdown",h),i.removeEventListener("click",p)}}function D(i,e){if(!e)return"";let t=N(e.entity_id),n=e.attributes.device_class;return i.formatEntityState?.(e)??i.localize?.(`component.${t}.entity_component.${n??"_"}.state.${e.state}`)??i.localize?.(`component.${t}.entity_component._.state.${e.state}`)??e.state}function T(i,e,t){let n=Number(e);return Number.isFinite(n)?n.toLocaleString(i?.locale?.language??"nl",{minimumFractionDigits:t??0,maximumFractionDigits:t??0}):"--"}var qe=["zondag","maandag","dinsdag","woensdag","donderdag","vrijdag","zaterdag"],We=["jan","feb","mrt","apr","mei","jun","jul","aug","sep","okt","nov","dec"],Re=(i=new Date)=>new Date(i.getFullYear(),i.getMonth(),i.getDate()),ce=(i,e)=>Math.round((Re(e)-Re(i))/864e5);function U(i){if(!i)return null;if(i instanceof Date)return Number.isNaN(+i)?null:i;let e=String(i).trim(),t=e.match(/^(\d{1,2})-(\d{1,2})-(\d{4})/);if(t)return new Date(+t[3],+t[2]-1,+t[1]);if(t=e.match(/^(\d{4})-(\d{1,2})-(\d{1,2})/),t)return new Date(+t[1],+t[2]-1,+t[3]);let n=new Date(e);return Number.isNaN(+n)?null:n}function le(i,e=new Date){if(!i)return"";let t=ce(e,i);return t<0?`${Math.abs(t)} dagen geleden`:t===0?"vandaag":t===1?"morgen":t===2?"overmorgen":t<=6?qe[i.getDay()]:`${qe[i.getDay()].slice(0,2)} ${i.getDate()} ${We[i.getMonth()]}`}var Ke=i=>i?`${i.getDate()} ${We[i.getMonth()]}`:"";var at=`
  :host {
    ${R}
    display: block;
...
`,L={accent:"var(--dac-accent-hi)",solar:"var(--dac-solar)",house:"var(--dac-house)",water:"var(--dac-grid-in)",magenta:"var(--dac-grid-out)",pink:"var(--dac-device-1)",teal:"var(--dac-device-2)",lit:"var(--dac-lit)",good:"var(--dac-good)",warn:"var(--dac-warn)",bad:"var(--dac-bad)",neutral:"var(--dac-ink-3)"},W={accent:"Accent",solar:"Oranje",house:"Blauw",water:"Lichtblauw",magenta:"Magenta",pink:"Roze",teal:"Groenblauw",lit:"Lampgeel",good:"Goed",warn:"Let op",bad:"Kritiek",neutral:"Neutraal"},z=(i,e="accent")=>L[i]??(i&&/[#(]|^var/.test(i)?i:L[e]),j=Symbol("incomplete"),ot=i=>`
  <div class="needs">
...
`,de=null,he=class extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),de=de??[V(ct)],this.shadowRoot.adoptedStyleSheets=de,this.value_="",this.label="Icoon",this.fallback="question",this.auto=!0}set value(e){this.value_=e??"",this.built_&&this.paint_()}get value(){return this.value_}connectedCallback(){this.built_||(this.built_=!0,this.build_())}build_(){this.shadowRoot.innerHTML=`
      <div class="label"></div>
      <div class="box">
        ...
        <div class="panel">
          ${st.map(([t,n])=>`
            <div class="group">
              <h4>${t}</h4>
              <div class="grid">
                ${n.map(a=>`<button type="button" class="opt" data-icon="${a}" title="${a}" aria-pressed="false">${w[a]??""}</button>`).join("")}
              </div>
            </div>`).join("")}
          <div class="mdi">
  ...
  *, *::before, *::after { box-sizing: border-box; }
  ...
  :focus-visible { outline: 2px solid var(--dac-accent-hi); outline-offset: 2px; }
`,pe=null,ue=class extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),pe=pe??[V(ht)],this.shadowRoot.adoptedStyleSheets=pe,this.value_="",this.label="Kleur",this.statuses=!1}set value(e){this.value_=e??"",this.built_&&this.paint_()}get value(){return this.value_}connectedCallback(){this.built_||(this.built_=!0,this.build_())}swatch(e){return`<button type="button" class="sw" data-tone="${e}" style="--c:${L[e]}"
      title="${W[e]}" aria-label="${W[e]}" aria-pressed="false">${w.check}</button>`}build_(){this.shadowRoot.innerHTML=`
      <div class="label"></div>
      <div class="box">
  ...
  `;validate(e){return{layout:"row",show_state:!0,show_name:!0,show_icon:!0,...e}}watched(){return[this.config.entity].filter(Boolean)}tone_(){let e=this.config;if(e.tone)return z(e.tone);if(N(e.entity)!=="light")return L.accent;let t=f(this.hass,e.entity),n=t?.state==="on"?t.attributes?.rgb_color:null;return n?`rgb(${n[0]},${n[1]},${n[2]})`:L.lit}template(){let e=this.config;return this.setAttribute("layout",["row","tile","compact"].includes(e.layout)?e.layout:"row"),`
...
`;var bt=new Set(["brightness","color_temp","hs","rgb","rgbw","rgbww","xy","white"]),vt=new Set(["hs","rgb","rgbw","rgbww","xy"]),Se=i=>i?.attributes?.supported_color_modes??[],xt=i=>Se(i).some(e=>bt.has(e)),oe=i=>Se(i).some(e=>vt.has(e)),re=i=>Se(i).includes("color_temp"),Ue=i=>Math.max(1,Math.round((i??0)/255*100)),Me=class extends _{static css=`
    :host { display: block; }
  ...
  `;validate(e){return e.entity||e.temperature||e.humidity?{...e}:{...e,[j]:"Kies een thermostaat, of een temperatuursensor."}}watched(){let e=this.config;return[e.entity,e.temperature,e.humidity].filter(Boolean)}step_(){let e=M(this.hass,this.config.entity);return Number(this.config.step??e.target_temp_step)||.5}template(){let e=this.config;return e.bare&&this.setAttribute("bare",""),e.entity||this.setAttribute("readout",""),`
      ...
      </div>`}wire(){let e=this.config;this.teardown_.push(()=>clearTimeout(this.sendTimer_)),this.teardown_.push(A(this.$(".chip"),{onTap:()=>P(this,e.entity||e.temperature||e.humidity)}));let t=this.$(".set");t&&t.querySelectorAll("button").forEach(n=>this.on(n,"click",()=>this.nudge_(Number(n.dataset.d))))}nudge_(e){let t=this.config,n=M(this.hass,t.entity),a=this.step_(),o=Number(n.min_temp??5),r=Number(n.max_temp??35),c=this.pending_??Number(n.temperature);if(!Number.isFinite(c))return;let l=Math.min(r,Math.max(o,Math.round((c+e*a)/a)*a));this.pending_=l,this.paintTarget_(),clearTimeout(this.sendTimer_),this.sendTimer_=setTimeout(()=>{this.sendTimer_=null,this.hass.callService("climate","set_temperature",{entity_id:t.entity,temperature:this.pending_}),setTimeout(()=>{this.pending_=null,this.paint()},1500)},450)}paintTarget_(){let e=this.$(".target");if(!e)return;let t=M(this.hass,this.config.entity),n=this.pending_??Number(t.temperature);e.classList.toggle("pending",this.pending_!=null),e.textContent=Number.isFinite(n)?`${T(this.hass,n,n%1?1:0)}\xB0`:"--"}paint(){let e=this.config,t=e.entity?f(this.hass,e.entity):null,n=e.entity?I(t):!1;this.toggleAttribute("dead",n);let a=wt(t),o=e.tone?z(e.tone):Ee[a]??"var(--dac-ink-3)";this.$(".card").style.setProperty("--tone",o),this.toggleAttribute("busy",!!Ee[a]);let r=this.$(".chip"),c=e.icon||"thermo";r.dataset.icon!==c&&(r.dataset.icon=c,r.innerHTML=$(c,"thermo")),r.style.setProperty("--tone",Ee[a]?o:"var(--dac-ink-3)"),this.text(".nm",C(this.hass,e.entity||e.temperature||e.humidity,e.name));let l=e.temperature?Fe(f(this.hass,e.temperature)):Number(M(this.hass,e.entity).current_temperature),h=this.hass?.config?.unit_system?.temperature??"\xB0C";this.text(".temp",Number.isFinite(l)?`${T(this.hass,l,1)} ${h}`:"--");let p=e.humidity?Fe(f(this.hass,e.humidity)):null,u=this.$(".hum");u.innerHTML=p==null?"":`${w.drop}${T(this.hass,p,0)}%`,this.text(".sep",p==null?"":"\xB7"),e.entity&&!e.humidity&&Ze[a]&&a!=="idle"&&(this.text(".sep","\xB7"),u.textContent=Ze[a]),this.paintTarget_();let m=this.$(".set");if(m){let k=M(this.hass,e.entity),d=this.pending_??Number(k.temperature);m.querySelector('[data-d="-1"]').disabled=n||d<=Number(k.min_temp??5),m.querySelector('[data-d="1"]').disabled=n||d>=Number(k.max_temp??35)}}getCardSize(){return 1}getGridOptions(){return{columns:12,rows:1,min_columns:4,min_rows:1,max_rows:1}}static getConfigElement(){return document.createElement("domotiapp-climate-card-editor")}static getStubConfig(e,t){let n=t?.find(a=>a.startsWith("climate."));return n?{entity:n}:{}}},ze=class extends E{pickers(){return[{key:"icon",kind:"icon",label:"Icoon",fallback:"thermo"},{key:"tone",kind:"tone",label:"Vaste kleur (leeg = volgt de ketel)"}]}schema(){return[{name:"entity",selector:g.entity("climate")},{name:"temperature",selector:{entity:{domain:"sensor",device_class:"temperature"}}},{name:"humidity",selector:{entity:{domain:"sensor",device_class:"humidity"}}},{name:"name",selector:g.text()},{name:"step",selector:g.number(.1,5,.1)}]}label(e){return{entity:"Thermostaat (optioneel)",temperature:"Temperatuursensor (optioneel)",humidity:"Vochtigheidssensor (optioneel)",name:"Naam",step:"Stap van de knoppen"}[e.name]??super.label(e)}helper(e){if(e.name==="entity")return"Leeg laten voor een kaart die alleen meet. Met thermostaat komen de stelknoppen erbij.";if(e.name==="temperature")return"Wint van de meting van de thermostaat zelf. Handig als er een betere sensor in de kamer hangt.";if(e.name==="step")return"Leeg laten volgt de thermostaat, en anders een halve graad."}};O("domotiapp-climate-card-editor",ze);S("domotiapp-climate-card",Ce,{name:"DomotiApp Klimaat",description:"Thermostaat, losse temperatuur- en vochtsensor, of allebei."});var Xe=i=>Math.min(Math.max(1,Number(i)||2),3),Ye=i=>typeof i=="string"?{entity:i}:{...i};function se(i){for(i.bewaard??=[];i.items.length<i.columns;)i.items.push(i.bewaard.pop()??{entity:""});for(;i.items.length>i.columns;){let e=i.items.pop();e.entity&&i.bewaard.push(e)}return i}function yt(i){let e=Array.isArray(i.rows)&&i.rows.length?i.rows.map(n=>({columns:Xe(n.columns),items:(n.items??n.entities??[]).map(Ye)})):(()=>{let n=(i.items??i.entities??[]).map(Ye);return n.length?[{columns:Xe(i.columns),items:n}]:[]})(),t=[];for(let n of e){let a=[];for(let o=0;o<n.items.length;o+=n.columns)a.push(n.items.slice(o,o+n.columns));a.length||a.push([]);for(let o of a)t.push(se({columns:n.columns,items:o}))}return t}var Je=i=>i.map(e=>({columns:e.columns,items:e.items.filter(t=>t.entity)})).filter(e=>e.items.length),_t=`
...
`,Oe=class extends HTMLElement{constructor(){super(),this.rows_=[],this.rest_={},this.open_=new Set,this.syncs_=[]}setConfig(e){this.rest_={...e},delete this.rest_.rows,delete this.rest_.items,delete this.rest_.entities,delete this.rest_.columns;let t=yt(e);this.gebouwd_&&JSON.stringify(Je(t))===this.uit_||(this.rows_=t,this.eersteKeer_||(this.eersteKeer_=!0,this.rows_.length===1&&this.open_.add("r0")),this.build_())}set hass(e){this.hass_=e;for(let t of this.querySelectorAll("ha-form, dac-icon-picker, dac-tone-picker"))t.hass=e;this.gebouwd_||this.build_()}get hass(){return this.hass_}connectedCallback(){this.gebouwd_||this.build_()}onthoud_(e,t){e.open=this.open_.has(t),e.addEventListener("toggle",()=>{e.open?this.open_.add(t):this.open_.delete(t)})}rijWeg_(e){let t=new Set;for(let n of this.open_){let a=/^r(\d+)(?:i(\d+))?$/.exec(n);if(!a)continue;let o=Number(a[1]);o!==e&&t.add(o>e?`r${o-1}${a[2]===void 0?"":`i${a[2]}`}`:n)}this.open_=t}itemWeg_(e,t){let n=new Set;for(let a of this.open_){let o=/^r(\d+)i(\d+)$/.exec(a);if(!o||Number(o[1])!==e){n.add(a);continue}let r=Number(o[2]);r!==t&&n.add(r>t?`r${e}i${r-1}`:a)}this.open_=n}legePlekkenOpen_(e,t){e.items.forEach((n,a)=>{n.entity||this.open_.add(`r${t}i${a}`)})}async build_(){if(!this.hass_||!this.rows_)return;await customElements.whenDefined("ha-form"),this.gebouwd_=!0,this.replaceChildren(),this.syncs_=[];let e=document.createElement("style");e.textContent=_t;let t=document.createElement("div");if(t.className="dac-ed",this.append(e,t),this.rows_.forEach((a,o)=>t.appendChild(this.rijBlok_(a,o))),!this.rows_.length){let a=document.createElement("p");a.className="uitleg",a.textContent="Een rij is \xE9\xE9n regel op de kaart, met \xE9\xE9n, twee of drie entiteiten naast elkaar. Elke rij heeft zijn eigen indeling.",t.appendChild(a)}let n=document.createElement("button");n.type="button",n.className="rijtoevoegen",n.textContent="\uFF0B  Rij toevoegen",n.addEventListener("click",()=>{let a=se({columns:2,items:[]});this.rows_.push(a);let o=this.rows_.length-1;this.open_.add(`r${o}`),this.legePlekkenOpen_(a,o),this.emit_(),this.build_()}),t.appendChild(n)}binnenKop_(e,t){return e.addEventListener("click",n=>{n.preventDefault(),n.stopPropagation(),t(n)}),e}rijBlok_(e,t){let n=document.createElement("details");n.className="rij",this.onthoud_(n,`r${t}`);let a=document.createElement("summary"),o=document.createElement("span");o.className="pijl",o.textContent="\u203A";let r=document.createElement("span");r.className="titel";let c=document.createElement("b");c.textContent=`Rij ${t+1}`;let l=document.createElement("small");r.append(c,l);let h=document.createElement("span");h.className="kolommen";let p=[1,2,3].map(d=>{let v=document.createElement("button");return v.type="button",v.textContent=String(d),v.title=`${d} entiteit${d>1?"en":""} in deze rij`,h.appendChild(this.binnenKop_(v,()=>{e.columns!==d&&(e.columns=d,se(e),this.open_.add(`r${t}`),this.legePlekkenOpen_(e,t),this.emit_(),this.build_())})),v}),u=()=>{let d=e.items.filter(b=>b.entity),v=`${e.columns} kolom${e.columns>1?"men":""}`;l.textContent=d.length?`${v} \xB7 ${d.map(b=>this.itemNaam_(b)).join(", ")}`:`${v} \xB7 nog leeg`,p.forEach(b=>b.setAttribute("aria-pressed",String(e.columns===Number(b.textContent))))};this.syncs_.push(u);let m=document.createElement("button");m.type="button",m.className="weg",m.title="Rij verwijderen",m.textContent="\u2715",this.binnenKop_(m,()=>{this.rows_.splice(t,1),this.rijWeg_(t),this.emit_(),this.build_()}),a.append(o,r,h,m);let k=document.createElement("div");return k.className="rijbody",e.items.forEach((d,v)=>k.appendChild(this.itemBlok_(e,d,t,v))),n.append(a,k),u(),n}itemNaam_(e){return e.name||this.hass_?.states?.[e.entity]?.attributes?.friendly_name||e.entity}itemBlok_(e,t,n,a){let o=document.createElement("details");o.className="item",this.onthoud_(o,`r${n}i${a}`);let r=document.createElement("summary"),c=document.createElement("span");c.className="pijl",c.textContent="\u203A";let l=document.createElement("span");l.className="nr",l.textContent=String(a+1),l.title=`Plek ${a+1} in de rij`;let h=document.createElement("span");h.className="titel";let p=document.createElement("b"),u=document.createElement("small");h.append(p,u);let m=document.createElement("button");m.type="button",m.className="weg",m.title="Deze plek leegmaken",m.textContent="\u2715",this.binnenKop_(m,()=>{e.items.splice(a,1),this.itemWeg_(n,a),se(e),this.emit_(),this.build_()}),r.append(c,l,h,m);let k=document.createElement("div");k.className="itembody";let d=document.createElement("ha-form");d.hass=this.hass_,d.schema=[{name:"entity",selector:{entity:{}}}],d.computeLabel=()=>"Entiteit",d.addEventListener("value-changed",x=>{x.stopPropagation(),t.entity=x.detail.value.entity??"",this.emit_()});let v=document.createElement("dac-icon-picker");v.label="Icoon",v.hass=this.hass_,v.addEventListener("value-changed",x=>{x.stopPropagation(),x.detail.value?t.icon=x.detail.value:delete t.icon,this.emit_()});let b=document.createElement("dac-tone-picker");b.label="Kleur",b.hass=this.hass_,b.addEventListener("value-changed",x=>{x.stopPropagation(),x.detail.value?t.tone=x.detail.value:delete t.tone,this.emit_()});let y=document.createElement("ha-form");y.hass=this.hass_,y.schema=[{name:"name",selector:{text:{}}},{name:"show_state",selector:{boolean:{}}},{name:"icon_tap_action",selector:{ui_action:{default_action:"toggle"}}},{name:"icon_hold_action",selector:{ui_action:{default_action:"more-info"}}},{name:"tap_action",selector:{ui_action:{default_action:"more-info"}}},{name:"hold_action",selector:{ui_action:{default_action:"more-info"}}}],y.computeLabel=x=>({name:"Naam (overschrijft die van de entiteit)",show_state:"Status tonen",icon_tap_action:"Tikken op het icoon",icon_hold_action:"Vasthouden op het icoon",tap_action:"Tikken op de regel",hold_action:"Vasthouden op de regel"})[x.name]??x.name,y.computeHelper=x=>x.name==="icon_tap_action"?"Het icoon en de regel zijn twee knoppen: het icoon schakelt, de regel opent of navigeert.":void 0,y.addEventListener("value-changed",x=>{x.stopPropagation();let B=x.detail.value;B.name?t.name=B.name:delete t.name,B.show_state===!1?t.show_state=!1:delete t.show_state;for(let Y of["icon_tap_action","icon_hold_action","tap_action","hold_action"])B[Y]?t[Y]=B[Y]:delete t[Y];this.emit_()});let q=()=>{p.textContent=t.entity?this.itemNaam_(t):"Kies een entiteit",u.textContent=t.entity||"",o.dataset.leeg=String(!t.entity),m.hidden=!t.entity,d.data={entity:t.entity||void 0},v.value=t.icon??"",b.value=t.tone??"",y.data={name:t.name??"",show_state:t.show_state??!0,icon_tap_action:t.icon_tap_action,icon_hold_action:t.icon_hold_action,tap_action:t.tap_action,hold_action:t.hold_action}};return this.syncs_.push(q),k.append(d,v,b,y),o.append(r,k),q(),o}emit_(){let e=Je(this.rows_);this.uit_=JSON.stringify(e);for(let t of this.syncs_)t();this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:{...this.rest_,rows:e}},bubbles:!0,composed:!0}))}};customElements.get("domotiapp-entities-card-editor")||customElements.define("domotiapp-entities-card-editor",Oe);var Qe=44,je=6,et=i=>typeof i=="string"?{entity:i}:{...i};function kt(i){if(Array.isArray(i.rows)&&i.rows.length)return i.rows.map(t=>({columns:Math.min(Math.max(1,Number(t.columns)||2),3),items:(t.items??t.entities??[]).map(et)}));let e=(i.items??i.entities??[]).map(et);return e.length?[{columns:Math.min(Math.max(1,Number(i.columns)||2),3),items:e}]:[]}var Ae=class extends _{static css=`
    :host { display: block; height: 100%; }
  ...
  `;validate(e){let t=kt(e);return t.some(n=>n.items.length)?{show_state:!0,...e,rows:t}:{...e,[j]:"Voeg een rij toe en kies daar entiteiten in."}}watched(){return this.config.rows.flatMap(e=>e.items.map(t=>t.entity))}item_(e,t){return this.config.rows[+e]?.items[+t]}tone_(e){if(e.tone)return z(e.tone);if(this.config.tone)return z(this.config.tone);if(N(e.entity)!=="light")return L.accent;let t=f(this.hass,e.entity),n=t?.state==="on"?t.attributes?.rgb_color:null;return n?`rgb(${n[0]},${n[1]},${n[2]})`:L.lit}template(){let e=this.config;return e.bare&&this.setAttribute("bare",""),this.style.containerType="inline-size",`<div class="card surface">${e.rows.map((n,a)=>`
      ...
      </div>`).join("")}</div>`}wire(){this.$$(".it").forEach(e=>{let t=this.item_(e.dataset.r,e.dataset.i);if(!t)return;let n=(o,r)=>ne(this,this.hass,t,t[o]??r);this.teardown_.push(A(e,{onTap:()=>n("tap_action",{action:"more-info"}),onHold:()=>n("hold_action",{action:"more-info"})}));let a=e.querySelector(".chip");this.teardown_.push(A(a,{onTap:()=>n("icon_tap_action",te(t.entity)),onHold:()=>n("icon_hold_action",{action:"more-info"})})),this.on(a,"click",o=>o.stopPropagation()),this.on(a,"pointerdown",o=>o.stopPropagation())})}paint(){this.$$(".it").forEach(e=>{let t=this.item_(e.dataset.r,e.dataset.i);if(!t)return;let n=f(this.hass,t.entity),a=ee(n),o=I(n);e.dataset.on=String(a),e.classList.toggle("unavailable",o);let r=this.tone_(t);e.style.setProperty("--tone",r);let c=e.querySelector(".chip"),l=Q(this.hass,t.entity,t.icon),h=t.icon||(l?`pic:${l}`:F(t.entity,M(this.hass,t.entity)));c.dataset.icon!==h&&(c.dataset.icon=h,c.classList.toggle("pic",!!l),c.innerHTML=l?`<img src="${l}" alt="" loading="lazy" />`:$(t.icon||F(t.entity,M(this.hass,t.entity)))),c.style.setProperty("--tone",l?"var(--dac-ink-3)":a?r:"var(--dac-ink-3)");let p=C(this.hass,t.entity,t.name);this.text(e.querySelector(".nm"),p),c.setAttribute("aria-label",`${p} schakelen`);let u=e.querySelector(".st");if((t.show_state??this.config.show_state)===!1)u.textContent="";else if(o)u.textContent="Niet bereikbaar";else if(!n||G(n.entity_id))u.textContent="";else if(N(n.entity_id)==="light"&&a&&n.attributes.brightness!=null)u.textContent=`${Math.round(n.attributes.brightness/255*100)}%`;else{let k=n.attributes.unit_of_measurement;u.textContent=k?`${n.state} ${k}`:D(this.hass,n)}e.setAttribute("aria-label",`${p}${n?`, ${D(this.hass,n)}`:""}`)})}lines_(){return(this.config?.rows??[]).reduce((e,t)=>e+Math.ceil((t.items.length||1)/t.columns),0)}getCardSize(){return Math.max(1,this.lines_())}getGridOptions(){let e=Math.max(1,this.lines_()),t=H(12+e*Qe+(e-1)*je);return{columns:12,rows:t,min_columns:4,min_rows:t,max_rows:t}}static getConfigElement(){return document.createElement("domotiapp-entities-card-editor")}static getStubConfig(){return{rows:[]}}};S("domotiapp-entities-card",Ae,{name:"DomotiApp Entiteiten",description:"Rijen entiteiten, elk met een eigen kolomindeling."});var Z={OPEN:1,CLOSE:2,SET_POSITION:4,STOP:8},X=(i,e)=>!!((i?.attributes?.supported_features??0)&e),Mt=(i={})=>{switch(i.device_class){case"garage":return{open:"garageOpen",closed:"garageClosed"};case"awning":case"blind":return{open:"awning",closed:"awning"};default:return{open:"shutterOpen",closed:"shutter"}}},Le=class extends _{static css=`
    :host { display: block; height: 100%; }
  ...
  `;validate(e){let t=e.covers??e.entities??(e.entity?[e.entity]:[]);return t.length?{...e,covers:t.map(n=>typeof n=="string"?{entity:n}:n)}:{...e,[j]:"Kies minstens \xE9\xE9n rolluik of zonnescherm."}}watched(){return this.config.covers.map(e=>e.entity)}keysHtml(e){return`
      ...
      </div>`).join("")}</div>`}wire(){this.dragging_=new Set,this.bound_=new Set,this.assumed_=new Map,this.$$(".cv").forEach(e=>{let t=e.dataset.i;e.querySelectorAll(".keys button").forEach(a=>{this.on(a,"click",()=>{let o=a.dataset.act,r={open:"open_cover",stop:"stop_cover",close:"close_cover"};this.hass.callService("cover",r[o],{entity_id:this.config.covers[+t].entity}),o!=="stop"&&(this.assumed_.set(t,o==="open"?"open":"closed"),this.paint())})});let n=this.config.covers[+t].entity;this.teardown_.push(A(e.querySelector(".chip"),{onTap:()=>P(this,n)}))})}paint(){this.$$(".cv").forEach(e=>{let t=e.dataset.i,n=this.config.covers[+t],a=f(this.hass,n.entity),o=M(this.hass,n.entity),r=!a||a.state==="unavailable",c=a?.state??"unknown";e.classList.toggle("unavailable",r),e.querySelector(".nm").textContent=C(this.hass,n.entity,n.name);let l=X(a,Z.SET_POSITION)&&o.current_position!=null,h=l?o.current_position>0?"open":"closed":c==="open"||c==="closed"?c:this.assumed_.get(t)??"closed";e.dataset.shown=h;let p=Mt(o),u=(h==="open"?n.icon_open:n.icon_closed)??(h==="open"?this.config.icon_open:this.config.icon_closed)??n.icon??p[h],m=e.querySelector(".chip");m.dataset.icon!==u&&(m.dataset.icon=u,m.innerHTML=$(u,p[h]));let k=e.querySelector(".st");this.dragging_.has(t)||(k.textContent=r?"Niet bereikbaar":c==="opening"?"Gaat open":c==="closing"?"Gaat dicht":l?`${o.current_position}% open`:c==="open"?"Open":c==="closed"?"Dicht":""),e.querySelectorAll(".keys button").forEach(b=>{if(b.dataset.act==="stop"){b.disabled=r||!X(a,Z.STOP);return}let y=b.dataset.act==="open";b.disabled=r||(y?!X(a,Z.OPEN):!X(a,Z.CLOSE))});let d=e.querySelector(".pos"),v=l&&this.config.show_position!==!1;if(d.hidden=!v,v){if(d.dataset.built||(d.dataset.built="1",d.innerHTML=K("position"),d.querySelector(".slider").setAttribute("aria-label","Positie")),!this.bound_.has(t)){this.bound_.add(t);let y=d.querySelector(".slider"),q=x=>{y.style.setProperty("--v",`${x}%`),y.setAttribute("aria-valuenow",String(x)),e.querySelector(".st").textContent=`${x}% open`};this.teardown_.push(ie(y,{value:()=>M(this.hass,n.entity).current_position??0,onInput:q,onCommit:x=>this.hass.callService("cover","set_cover_position",{entity_id:n.entity,position:x})}))}let b=d.querySelector(".slider");if(!b.classList.contains("dragging")){let y=o.current_position??0;b.style.setProperty("--v",`${y}%`),b.setAttribute("aria-valuenow",String(y))}}})}rows_(){let e=this.config?.covers??[],t=e.some(n=>X(f(this.hass,n.entity),Z.SET_POSITION));return H(12+Math.max(1,e.length)*42+(t?30:0))}getCardSize(){return this.rows_()}getGridOptions(){let e=this.rows_();return{columns:12,rows:e,min_columns:6,min_rows:e,max_rows:e}}static getConfigElement(){return document.createElement("domotiapp-cover-card-editor")}static getStubConfig(e,t){let n=t?.find(a=>a.startsWith("cover."));return{covers:n?[n]:[]}}},Ne=class extends E{defaults(){return{show_stop:!0,show_position:!0}}pickers(){return[{key:"icon_open",kind:"icon",label:"Icoon als het open staat",fallback:"shutterOpen"},{key:"icon_closed",kind:"icon",label:"Icoon als het dicht is",fallback:"shutter"},{key:"tone",kind:"tone",label:"Kleur"}]}schema(){return[{name:"covers",selector:{entity:{domain:"cover",multiple:!0}}},{name:"show_stop",selector:g.bool()}]}label(e){return{covers:"Rolluiken",show_stop:"Stopknop tonen"}[e.name]??super.label(e)}helper(e){if(e.name==="covers")return"Melden ze hun stand terug, dan komt er vanzelf een schuif bij. Zo niet, dan blijven het open, stop en dicht, en volgt het icoon de knop die je indrukt."}};O("domotiapp-cover-card-editor",Ne);S("domotiapp-cover-card",Le,{name:"DomotiApp Rolluiken",description:"Open, stop en dicht, met een eigen icoon voor open en dicht."});function $t(i){if(!i)return{label:"Onbekend",home:null};switch(i.state){case"home":return{label:"Thuis",home:!0};case"not_home":return{label:"Afwezig",home:!1};case"unknown":case"unavailable":return{label:"Onbekend",home:null};default:return{label:i.state,home:!1}}}var Te=class extends _{static css=`
    :host { display: block; height: 100%; }
  ...
  `;validate(e){let t=e.sensors??e.entities??(e.entity?[e.entity]:[]);return t.length?{show_hero:!0,show_list:!0,...e,sensors:t.map(n=>typeof n=="string"?{entity:n}:n)}:{...e,[j]:"Kies minstens \xE9\xE9n afvalsensor waarvan de status een datum is."}}watched(){return this.config.sensors.map(e=>e.entity)}read_(){let e=new Date;return this.config.sensors.map(t=>{let n=f(this.hass,t.entity);if(!n)return null;let a=U(n.state)??U(n.attributes.date)??U(n.attributes.next_date);if(!a)return null;let o=t.label??tt(C(this.hass,t.entity,t.name)),r=Et(t.label??t.entity+o),c=this.config.tones?.[t.entity];return{label:o,date:a,days:ce(e,a),tone:z(c??t.tone??r.tone),icon:t.icon??r.icon}}).filter(t=>t&&t.days>=0).sort((t,n)=>t.date-n.date)}template(){let e=this.config;return e.bare&&this.setAttribute("bare",""),`
      ...
      </div>`}paint(){let e=this.read_(),t=this.$(".hero"),n=this.$(".list"),a=this.$(".empty");if(a.hidden=e.length>0,t&&(t.hidden=e.length===0,e.length)){let o=e[0];t.style.setProperty("--tone",o.tone),this.setAttribute("urgency",o.days===0?"today":o.days===1?"tomorrow":"later");let r=t.querySelector(".bin");r.dataset.icon!==o.icon&&(r.dataset.icon=o.icon,r.innerHTML=$(o.icon,"bin")),this.text(t.querySelector(".eyebrow"),le(o.date)),this.text(t.querySelector(".big"),o.label),this.text(t.querySelector(".n"),o.days===0?"nu":String(o.days)),this.text(t.querySelector(".u"),o.days===0?"aan de weg":o.days===1?"dag":"dagen")}if(n){let o=this.config.show_hero===!1?e:e.slice(1),r=o.map(c=>`${c.label}${+c.date}`).join("|");if(n.dataset.sig===r)return;n.dataset.sig=r,n.innerHTML=o.map(c=>{let l=le(c.date),h=c.days<=6?`<small>${Ke(c.date)}</small>`:"";return`
        <div class="r" style="--tone:${c.tone}">
          <i></i><span>${c.label}</span>
          <span class="d">${l}${h}</span>
        </div>`}).join("")}}rows_(){let e=this.config?.sensors?.length??1;return this.config?.show_list===!1?1:this.config?.show_hero===!1?Math.max(1,H(20+e*33)):Math.max(2,e)}getCardSize(){return this.rows_()}getGridOptions(){let e=this.rows_();return{columns:12,rows:e,min_columns:6,min_rows:e,max_rows:e}}static getConfigElement(){return document.createElement("domotiapp-waste-card-editor")}static getStubConfig(e){return{sensors:Object.keys(e?.states??{}).filter(n=>/afval|waste|trash|garbage|ophaal/i.test(n)&&n.startsWith("sensor.")).filter(n=>U(e.states[n]?.state)).slice(0,6),title:"Afvalkalender"}}},Pe=class extends E{defaults(){return{show_hero:!0,show_list:!0}}setConfig(e){let t={...e};for(let[n,a]of Object.entries(e.tones??{}))t[`kleur:${n}`]=a;delete t.tones,super.setConfig(t)}serialize(e){let t={...e},n={};for(let a of Object.keys(t))a.startsWith("kleur:")&&(t[a]&&(n[a.slice(6)]=t[a]),delete t[a]);return Object.keys(n).length?t.tones=n:delete t.tones,t}schema(){let e=this.config_?.sensors??[],t=Object.keys(L).map(n=>({value:n,label:W[n]??n}));return[{name:"sensors",selector:{entity:{domain:"sensor",multiple:!0}}},...e.map(n=>typeof n=="string"?n:n.entity).filter(Boolean).map(n=>({name:`kleur:${n}`,selector:g.select(t)}))]}label(e){if(e.name.startsWith("kleur:")){let t=e.name.slice(6),n=this.hass?.states?.[t]?.attributes?.friendly_name??t;return`Kleur voor ${tt(n)||n}`}return{sensors:"Afvalsensoren",show_hero:"Eerstvolgende uitlichten",show_list:"Overige data tonen",bare:"Zonder kaartrand"}[e.name]??super.label(e)}helper(e){if(e.name==="sensors")return"Sensoren waarvan de status een datum is, bijvoorbeeld 18-08-2026. De kaart sorteert zelf; laat een kleur leeg om de bakkleur op de naam te laten kiezen."}};O("domotiapp-waste-card-editor",Pe);S("domotiapp-waste-card",Ie,{name:"DomotiApp Afvalkalender",description:"Eerstvolgende ophaling als hero, de rest eronder. Kleur per fractie."});var Ct="0.1.9";console.info(`%c DOMOTIAPP-CARDS %c ${Ct} `,"background:#026fa1;color:#e8e4de;font-weight:600;border-radius:3px 0 0 3px;padding:2px 6px","background:#12120f;color:#e8e4de;border-radius:0 3px 3px 0;padding:2px 6px");export{Ct as VERSION};
