/*! DomotiApp Cards 0.1.12 | MIT | https://github.com/Sven2410/domotiapp-cards */
var R=`
  --dac-bg:            #0c0c0a;
  --dac-bg-raise:      #12120f;
...
`,T={accent:"var(--dac-accent-hi)",solar:"var(--dac-solar)",house:"var(--dac-house)",water:"var(--dac-grid-in)",magenta:"var(--dac-grid-out)",pink:"var(--dac-device-1)",teal:"var(--dac-device-2)",lit:"var(--dac-lit)",good:"var(--dac-good)",warn:"var(--dac-warn)",bad:"var(--dac-bad)",neutral:"var(--dac-ink-3)"},ie={accent:"Accent",solar:"Oranje",house:"Blauw",water:"Lichtblauw",magenta:"Magenta",pink:"Roze",teal:"Groenblauw",lit:"Lampgeel",good:"Goed",warn:"Let op",bad:"Kritiek",neutral:"Neutraal"},j=(i,e="accent")=>T[i]??(i&&/[#(]|^var/.test(i)?i:T[e]),O=Symbol("incomplete"),rt=i=>`
  <div class="needs">
...
`,ue=null,me=class extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),ue=ue??[V(ut)],this.shadowRoot.adoptedStyleSheets=ue,this.value_="",this.label="Kleur",this.statuses=!1}set value(e){this.value_=e??"",this.built_&&this.paint_()}get value(){return this.value_}set compact(e){this.toggleAttribute("compact",!!e)}get compact(){return this.hasAttribute("compact")}connectedCallback(){this.built_||(this.built_=!0,this.build_())}eigen_(){return!!this.value_&&!(this.value_ in T)}swatch(e){return`<button type="button" class="sw" data-tone="${e}" style="--c:${T[e]}"
  ...
  `;validate(e){return{layout:"row",show_state:!0,show_name:!0,show_icon:!0,...e}}watched(){return[this.config.entity].filter(Boolean)}tone_(){let e=this.config;return e.tone?j(e.tone):L(e.entity)!=="light"?T.accent:Q(f(this.hass,e.entity))??T.lit}template(){let e=this.config;return this.setAttribute("layout",["row","tile","compact"].includes(e.layout)?e.layout:"row"),`
...
`;var xt=new Set(["brightness","color_temp","hs","rgb","rgbw","rgbww","xy","white"]),wt=new Set(["hs","rgb","rgbw","rgbww","xy"]),Ee=i=>i?.attributes?.supported_color_modes??[],yt=i=>Ee(i).some(e=>xt.has(e)),re=i=>Ee(i).some(e=>wt.has(e)),se=i=>Ee(i).includes("color_temp"),Ze=i=>Math.max(1,Math.round((i??0)/255*100)),$e=class extends _{static css=`
    :host { display: block; }
